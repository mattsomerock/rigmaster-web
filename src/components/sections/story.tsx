  ...
  return (
    <section id="story" aria-labelledby="story-title" className="border-t border-line">
      <div className="container-lux py-(--sec)">
        ...
        <p className="mt-10 max-w-3xl text-[clamp(1.2rem,2.2vw,1.75rem)] leading-[1.7] font-light text-ink-2 lg:mt-14">
          เฝ้ากราฟทุกคืน เข้าไม้เพราะ “รู้สึกว่าน่าจะขึ้น”
          <br />
          แล้วถือต่อเพราะ “เดี๋ยวมันก็กลับมา”
        </p>

        <div className="mt-12 border-y border-line py-9 lg:mt-16 lg:py-12">
        ...
        <div className="mt-14 grid items-start gap-10 lg:mt-20 lg:grid-cols-12">
          ...
          <div className="space-y-7 text-[1.0625rem] leading-[1.9] text-ink-2 lg:col-span-7 lg:col-start-6">
            <p className="text-[clamp(1.3rem,2.2vw,1.65rem)] leading-[1.5] font-light text-ink">
            ...
            <blockquote className="border-l border-gold/60 pl-6 text-[clamp(1.2rem,2vw,1.5rem)] leading-[1.6] font-light text-ink">
